...
//   return (
//     <div className="bg-[#1B1C20] text-white rounded-lg shadow-lg p-4 mb-4">
...
//           <MdDeleteSweep size={25} className=" cursor-pointer" onClick={()=>{ dispatch(removeTransaction(id)); toast.success("Transaction Deleted SuccessFully!")}} />
//         </div>
//       </div>
//     </div>
//   );
